 ...
 *
 * Description: Creates a new node with the given value @n and adds it to the top
 * of the stack. If memory allocation fails for the new node, it prints an error
